;(function(a){"function"===typeof define&&define.amd?define(["jquery"],a):a(jQuery)})(function(a,h){function f(b,c){this._name=d;this._defaults=e;this.element=b;this.$element=a(b);this.options=a.extend({},e,c);this.init()}var d="drilldown",e;e={event:"click",selector:"a",speed:100,cssClass:{container:d+"-container",root:d+"-root",sub:d+"-sub",back:d+"-back"}};f.prototype={init:function(){var b=this;this.history=[];this.css={"float":"left",width:null};this.$container=this.$element.find("."+this.options.cssClass.container);
